...
const ContactForm: React.FC = () => {
  ...
  return (
    <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-4 md:p-6 border border-none">
      {submitted ? (
              ...
              <div className="flex flex-wrap gap-2">
                {COURSES.map(c => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full border text-sm font-medium transition-all ${formData.course === c
              ...
              <div className="flex flex-wrap gap-2">
                {COUNTRIES.map(c => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full border text-sm font-medium transition-all ${formData.targetCountry === c
                      ? 'border-brand-blue bg-brand-blue/10 text-brand-blue dark:bg-brand-blue/20 dark:text-white'
                      : 'border-gray-200 text-gray-600 hover:border-brand-blue/50 dark:border-slate-600 dark:text-gray-300'
                      }`}
                  >
