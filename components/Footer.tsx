    ...
    return (
        <footer className="font-sans border-t border-gray-100 dark:border-slate-800 transition-colors">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-16 border-b border-gray-100 dark:border-slate-800 pb-12">
                        ...
                        <div className="bg-gray-50 dark:bg-slate-800 p-2 rounded-[2rem] border border-gray-100 dark:border-slate-700 h-64 overflow-hidden relative">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2888.0082264293806!2d77.3220303745075!3d28.571739986840512!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce5b6d3c02b6f%3A0x1b4f6a6bc9643d3f!2siExplain%20Education!5e1!3m2!1sen!2sin!4v1773834668142!5m2!1sen!2sin"
            ...
            <div className="bg-[#011e33] py-8 text-center border-t border-white/5">
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/40">© 2026 iExplain Education. All Rights Reserved.</p>
            </div>
        </footer>
    );
};
