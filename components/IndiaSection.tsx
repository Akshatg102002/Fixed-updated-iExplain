...
import { createIndiaProgramPath } from '../utils.ts';
    ...
    <section className="py-12 bg-gray-50 dark:bg-slate-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-black text-brand-blue dark:text-white mb-6 tracking-tight">Study in India</h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {INDIA_COURSES.map((course, i) => (
            <div key={i} className="group bg-white dark:bg-slate-800 p-4 sm:p-8 rounded-3xl border border-gray-100 dark:border-slate-700 hover:border-brand-gold transition-all shadow-sm hover:shadow-xl">
              ...
              <Link to={createIndiaProgramPath(course.id)} className="text-brand-gold font-bold text-[10px] sm:text-xs uppercase tracking-widest flex items-center group/link">
                View Details
