...
export const AWARDS_ACHIEVEMENTS = [
  {
    id: 1,
  ...
  {
    id: 2,
    title: "Excellence in Student Counseling",
    organization: "Education World Awards",
    icon: "fa-solid fa-medal"
  },
  {
    id: 3,
    title: "Top Performer for Russia Admissions",
    organization: "Russian Education Council",
    icon: "fa-solid fa-star"
  },
  {
    id: 4,
    title: "100% Visa Success Rate Award",
    organization: "Study Abroad Forum",
